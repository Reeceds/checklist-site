...
#### Run this in Docker on another computer

-   The '.env' file and the 'ssl' files will need to be copied accross
...
-   Client: Run build command and delpoy as static site to Render.com
-   API: Dockerized and deployed as docker container to Render.com
